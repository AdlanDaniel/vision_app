...
void _configDatasource() {
  InjectionManager.i.registerFactory<AuthDatasource>(
    () => AuthDatasourceImpl(
      FirebaseClient.firebaseAuth(),
      InjectionManager.i.get<RestClient>(),
    ),
  );
}

void _configRepository() {
  InjectionManager.i.registerFactory<AuthRepository>(
    () => AuthRepositoryImpl(InjectionManager.i.get<AuthDatasource>()),
  );
}

void _configController() {
  InjectionManager.i.registerFactory<RegisterController>(
    () => RegisterController(InjectionManager.i.get<AuthRepository>()),
  );
  InjectionManager.i.registerFactory<LoginController>(
    () => LoginController(InjectionManager.i.get<AuthRepository>()),
  );
  InjectionManager.i.registerFactory<ForgotPasswordController>(
    () => ForgotPasswordController(InjectionManager.i.get<AuthRepository>()),
  );
  InjectionManager.i.registerFactory<OnBoardController>(
    () => OnBoardController(InjectionManager.i.get<AuthRepository>()),
  );
}
