...
class RestClientResponse<T> extends Equatable {
  ...
  @override
  List<Object?> get props => [data, type, headers, statusCode, statusMessage];
}

enum ErrorType { networkError, clientError, serverError, unknown }

class HttpError extends Equatable implements Exception {
  final ErrorType errorType;

  const HttpError({this.errorType = ErrorType.networkError});
